...
const googleConfig = {
    ...
    clientSecret: "AIzaSyD88nIDjdaHCEPyz-O2vTEe9lxakP9szrw",  // e.g. _ASDFA%DFASDFASDFASD#FAD- 
...
function getConnectionUrl(auth) {
    return auth.generateAuthUrl({ access_type: 'offline', prompt: 'consent', scope: defaultScope });
}
